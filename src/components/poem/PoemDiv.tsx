...
import { sizes, color } from "components/universal/_variables";
const paperTextureImg = require("images/paper-rect-contrast.jpg");
const treeBarkImg = require("images/tree-bark.jpg");
const circlePatternImg = require("images/contemporary_china_small.png");
const oldPaperImg = require("images/4345189-xs.jpg");
const f0c4457 = require("images/f0c4457.jpg");
const maxresdefault = require("images/maxresdefault.jpg");
const blueTile = require("images/blueTile.jpg");
const tile = require("images/life_original_wild_urban_shells_abstract_texture_love-572258.jpg");
const paintingCracks = require("images/painting-cracks.jpg");
const Alcala_lg = require("images/Alcala_lg.jpg");
const map = require("images/map2.jpg");
const blue = require("images/blue.jpg");
const triangles123 = require("images/triangles-123.jpg");
const mU0yXR99Bg91S1ACSyPq_w = require("images/1_mU0yXR99Bg91S1ACSyPq_w.jpg");
